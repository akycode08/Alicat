        ...
        public void LoadSessionData(SessionDataStore dataStore, MainPresenter? presenter, ISerialClient? serialClient)
        {
            try
            {
                ...
                else if (presenter != null)
                {
                    ...
                    sampleRate = FormOptions.AppOptions.Current.PollingFrequency ?? 500;
                }
                ...
                double maxIncrement = FormOptions.AppOptions.Current.MaxIncrement ?? 20.0;
                double minIncrement = FormOptions.AppOptions.Current.MinIncrement ?? 0.1;
                ...
                var sessionConfig = new
                {
                    ...
                    measurement = new
                    {
                        units = new
                        {
                            ...
                            time = FormOptions.AppOptions.Current.TimeUnits ?? "s"
                        },
                        settings = new
                        {
                            rampSpeed = rampSpeed,
