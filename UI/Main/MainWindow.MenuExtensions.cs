    ...
    public partial class MainWindow
    {
        ...
        private void MenuFileOpenSession_Click(object? sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Filter = "Precision Pressure Controller Session Files (*.als)|*.als|CSV Files (*.csv)|*.csv|All files (*.*)|*.*",
                    Title = "Open Session"
                };
        ...
        private void MenuFileSaveSessionAs_Click(object? sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Filter = "Precision Pressure Controller Session Files (*.als)|*.als|All files (*.*)|*.*",
        ...
        /// Использует ту же логику, что и экспорт из ChartWindow
        /// </summary>
        private void MenuFileExportGraphImage_Click(object? sender, EventArgs e)
        {
            try
            {
                // Проверяем, открыт ли ChartWindow
                ...
                // Используем тот же метод экспорта, что и кнопка Export в ChartWindow
        ...
        private void MenuFileSessionConfiguration_Click(object? sender, EventArgs e)
        {
            try
            {
                using var form = new SessionConfigurationDialog();
