...
{
    /// <summary>
    /// Главное окно приложения Precision Pressure Controller.
    ...
    public partial class MainWindow : Form, IMainView
    {
        ...
        // _dataStore moved to MainWindow.Presenter.cs to avoid ambiguity
        // private readonly SessionDataStore _dataStore = new();

        private TerminalWindow? _terminalForm;
        private ChartWindow? _graphForm;
        private DataTableWindow? _tableForm;
        ...
        public MainWindow()
        {
            ...
            // Применяем тему после инициализации (цвета и стили из MainWindow.Theme.cs)
            ...
            this.Shown += (sender, e) =>
            {
                if (OptionsWindow.AppOptions.Current.AutoConnectOnStartup)
                {
        ...
        private void ApplyOptionsToUi()
        {
            ...
            {
                var rampSpeed = OptionsWindow.AppOptions.Current.PressureRamp;
