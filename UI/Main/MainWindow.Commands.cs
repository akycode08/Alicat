...
{
    /// <summary>
    /// Partial class MainWindow: Command handlers.
    ...
    public partial class MainWindow
    {
        ...
        // PAUSE / CONTINUE
        // ====================================================================
        // Обработчик перенесен в MainWindow.Presenter.cs (btnPause_Click_Presenter)
        ...
        private void btnOptions_Click(object? sender, EventArgs e)
        {
            ...
            dlg.Applied += (_, __) =>
            {
                ...
                // Синхронизируем thresholds в ChartWindow (если открыт)
                ...
                System.Diagnostics.Debug.WriteLine($"[btnOptions_Click] Applied event - AutoConnectOnStartup = {OptionsWindow.AppOptions.Current.AutoConnectOnStartup}");
                SaveSettingsToFile();
            };
        ...
        // SaveSettingsToFile доступен напрямую из MainWindow.Presenter.cs (partial class)
        ...
        private void btnTable_Click(object? sender, EventArgs e)
        {
            ...
            {
                _tableForm = new DataTableWindow(DataStore);
        ...
        private void btnTerminal_Click(object? sender, EventArgs e)
        {
            ...
            {
                _terminalForm = new TerminalWindow();
                _terminalForm.CommandSent += TerminalWindow_CommandSent;
            }
