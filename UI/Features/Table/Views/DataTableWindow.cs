...
using PrecisionPressureController.UI.Features.Table.Models;
...
namespace PrecisionPressureController.UI.Features.Table.Views
{
    ...
    public partial class DataTableWindow : Form, ITableView
    {
        ...
        /// <summary>
        /// Явная реализация ITableView.Focus() - интерфейс требует void, а Control.Focus() возвращает bool
        /// </summary>
        void ITableView.Focus()
        {
            base.Focus();
        }
        ...
        public DataTableWindow(SessionDataStore dataStore)
        {
        ...
        private void BtnExport_Click(object sender, EventArgs e)
        {
            using var saveDialog = new SaveFileDialog
            {
                ...
                FileName = $"PrecisionPressureController_Data_{DateTime.Now:yyyyMMdd_HHmmss}.csv"
            };
